        ...
        <section id="ethos" ref={containerRef} style={{ padding: 'var(--spacing-section) 0', position: 'relative', overflow: 'hidden' }}>
            <div className="container">
                <div style={{
                    ...
                    {/* Left: text */}
                    <div style={{ gridColumn: isMobile ? undefined : 'span 5', position: 'relative', zIndex: 2 }}>
                        <motion.div
                        ...
                        >
                            ...
                            <motion.h2 variants={textReveal} style={{ fontSize: isMobile ? 'clamp(2.2rem, 8vw, 3rem)' : 'clamp(3rem, 5vw, 5rem)', lineHeight: 1.1, marginBottom: '2rem' }}>
                                A Legacy in <br />
                                <span style={{ fontStyle: 'italic' }}>Vrindavan.</span>
                            </motion.h2>
                            <motion.p variants={textReveal} style={{ fontSize: isMobile ? '1rem' : '1.2rem', lineHeight: 1.8, color: 'inherit', marginBottom: '3rem' }}>
                    ...
                    <div style={{
                        ...
                        <motion.div style={{ position: 'relative', zIndex: 1, width: '100%', height: '100%', overflow: 'hidden', y: isMobile ? 0 : y }}>
                            <img
